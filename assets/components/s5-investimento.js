  ...
  <div class="flex-1 grid grid-cols-2 gap-0 pt-20">
    ...
    <div class="px-14 py-12 flex flex-col justify-center">
      ...
      <div class="inv-box bg-[#0C1410] rounded-[20px] p-10 mt-7 relative overflow-hidden">
        ...
        <div class="text-[clamp(26px,3vw,42px)] font-black text-white tracking-[-0.03em] leading-[1.15] mb-[10px]">Entrada de <em class="text-[#1DB954] not-italic">R$ 12.500</em><br>+ 6 parcelas de <em class="text-[#1DB954] not-italic">R$ 8.500</em></div>
        <div class="text-[14px] text-white/30 mb-6">Valor total: <strong class="text-white/55 font-semibold">R$ 63.500,00</strong></div>
